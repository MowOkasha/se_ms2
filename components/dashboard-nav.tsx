...
export function DashboardNav() {
  ...
  const navItems: { [key: string]: NavItem[] } = {
    student: [
      ...
      {
        title: "Profile",
        href: "/dashboard/student?tab=profile",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      {
        title: "Internships",
        href: "/dashboard/student?tab=internships",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      {
        title: "Reports",
        href: "/dashboard/student?tab=reports",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      {
        title: "Assessments",
        href: "/dashboard/student?tab=assessments",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      {
        title: "Workshops",
        href: "/dashboard/student?tab=workshops",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      {
        title: "Appointments",
        href: "/dashboard/student?tab=appointments",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
    ...
    "pro-student": [
      ...
      {
        title: "Profile",
        href: "/dashboard/pro-student?tab=profile",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      },
      {
        ...
        href: "/dashboard/pro-student?tab=past-internships",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
