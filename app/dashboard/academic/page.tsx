...
import { InternshipReportReview } from "@/components/internship-report-review"
...
export default function AcademicDashboard() {
  ...
  return (
    <DashboardShell>
      <DashboardHeader
        heading="Academic Advisor Dashboard"
        ...
        <TabsContent value="students" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage and monitor your assigned students' internships</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {studentsList.map((student) => (
